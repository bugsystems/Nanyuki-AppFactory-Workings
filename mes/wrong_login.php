...
<body>
	<div id="templatemo_container">
		...
		<fieldset style="border-color:#000099; width:420px">
          <legend style="color:#FF0000">Wrong Credentials Try again </legend>
          <form action="login_p.php" method="post">
            <pre>
Email    : <input type="text" name="email" />
Password : <input type="password" name="pass" />
		       <input name="submit" type="submit" class="more" value="Login"/> 
		    </pre>
          </form>
		  </fieldset>
        <a href="register.php" class="more">Register</a> </div>
