...
<body>
	...
	<div id="templatemo_container">
		...
		<div>
		<?php include "nivo-slider/slider.php";?>
		</div>
		<!-- InstanceEndEditable -->
		...
		<div>
		  <p ><strong><em><h1>medical  expert system</h1></em></strong><br />
              <em>This is a medical system where  patients will be  to enter their symptoms  and get to know what they are suffering from and get prescription for drugs.</em><em>If the patients  needs to go for lab tests it will order the lab tests and once the results are  out it will give the necessary drug prescription. This will ensure easy access  to medical services.</em></p>
		</div>
          <div class="cleaner"></div>
        </div>
        <!-- InstanceEndEditable -->
